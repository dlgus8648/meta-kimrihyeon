FILESEXTRAPATHS:prepend := "${THISDIR}/files/first_module:${THISDIR}/files:"

SRC_URI += " \
    file://kim_gdb-fragment.cfg \
    file://0001-First-module-Compile.patch \
    file://first_module/kim_module.c \
"
...
do_patch:append() {
    install -d ${S}/drivers/kimrihyeon
    cat ${WORKDIR}/first_module/kim_module.c > ${S}/drivers/kimrihyeon/kim_module.c
}
